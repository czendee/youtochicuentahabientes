export const descriptions = {
  resources: {
    ...
    f1: ["Computing Unit", ""],
    N: ["Naval Capacity", ""],
    S1: ["Mission Engineer", "Builder Engineer use  robots, circuits, simualtions and data to design  missions and  provide story board for the Missions. Design and build the EXECUTION PLAN  for each Mission (THE BOOK)"],
    SP: [
      "Missions Design.",
